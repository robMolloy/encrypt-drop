...
const isPaymentIntentStatusSucceededFn = httpsCallable(functions, "isPaymentIntentStatusSucceeded");
const successResponseSchema = z.object({
  data: z.object({ success: z.literal(true) }),
});

export const isPaymentIntentStatusSucceeded = async (p: { paymentIntentId: string }) => {
